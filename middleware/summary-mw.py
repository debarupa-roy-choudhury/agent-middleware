...
agent = create_agent(
    ...
    middleware=[
        SummarizationMiddleware(
            model="openai:gpt-4o-mini",
            trigger=("messages", 6),# trigger the summarization after 6 messages
            keep=("messages", 2)  # after summarizing keep latest 2 messsages unchanged and before older that summarise
        )
