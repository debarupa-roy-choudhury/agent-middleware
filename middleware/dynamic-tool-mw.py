# Give the model right tool at right time
...
# dynamic tool selection middleware --> @wrap_model_call
@wrap_model_call
def pick_tools(request, handler):
    ...
    if any(word in question for word in MONEY_WORDS):
        ...
        # Give the model only the money-related tools for this model call
